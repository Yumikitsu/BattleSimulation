...
namespace BattleSimulation.console.Monsters
{
    public class Baubert : IMonster
    {
        ...
        {
            party[index] = new Bauberry(this.level, this.experience, this.moves, this.health); //Replace the monster in the index position with the evolved version
        ...
        public Baubert(int level, EXP? exp = null, List<IMoves>? moves = null, int health = -1)
        {
            //Level
            this.level = level;
